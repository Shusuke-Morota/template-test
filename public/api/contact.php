<?php
  ...
  $from = mb_encode_mimeheader("contact@example.com");
  $header = "From: ".$from."<contact@example.com>\n";
  $header .= "Return-Path:contact@example.com\n";
  $header .= "Reply-to:contact@example.com\n";
  $opt = "-f"."contact@example.com"; //送信エラーの時にエラーメールを返す先
  ...
  HTML;
    ...
    mb_send_mail("daichiexperience@gmail.com", "お客様よりお問い合わせがありました", $message2, $header, $opt);
